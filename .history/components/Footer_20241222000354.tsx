...
const Footer = () => {
  return (
    <footer className="relative w-full pt-20 pb-10 bg-gray-900" id="contact">
      {/* Background grid */}
        ...
        <div className="flex items-center gap-4 mt-6 md:mt-0">
          {socialMedia.map((info) => (
            <a
              ...
              className="w-10 h-10 flex justify-center items-center rounded-lg bg-opacity-75 bg-gray-800 border border-gray-700 hover:opacity-80 transition-opacity"
