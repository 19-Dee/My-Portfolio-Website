...
export const TextGenerateEffect = ({
  ...
  const renderWords = () => {
    const wordsArray = [
      ...
      { text: "Cloud Security Practitioner", isPurple: true, isNewLine: false }, // Second line, "Cloud Security Practitioner" in purple
    ];
        ...
        {wordsArray.map((wordObj, idx) => (
          <motion.span
            ...
            className={`${wordObj.isPurple ? "text-purple" : "text-white"} ${
              wordObj.isNewLine ? "block" : "inline-block"
            }`} // Ensure "a" is block for its own line
          >
            {wordObj.text}
          </motion.span>
        ))}
