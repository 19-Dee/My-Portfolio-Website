...
export const testimonials = [
  {
    heading: "My Vision",
    quote:
      "My Vision: I am dedicated to becoming a leading expert in Cloud Security and AI. My immediate goals include earning the AWS Certified Security Specialty certification and contributing to impactful projects that leverage AI to secure multi-cloud environments.",
    name: "Dishen Patel",
