...
export const gridItems = [
  {
    ...
    className:
      "col-span-1 md:col-span-1 lg:col-span-2 row-span-3 relative overflow-hidden rounded-lg",
    imgClassName:
  ...
  },
  {
    ...
    className:
      "col-span-1 md:col-span-1 lg:col-span-2 row-span-1 relative rounded-lg",
    imgClassName: "",
    titleClassName: "px-4 pt-4 text-lg font-bold text-white",
    descriptionClassName: "px-8 pb-8 text-sm text-gray-400",
    img: "",
    spareImg: "",
  },
  {
