...
export const gridItems = [
  ...
  },
  {
    id: 4,
    title:
      "Passion for securing sensitive cloud data and driving data-driven insights.",
    description: "BSc Math and Statistics • MSc Data Science",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
    titleClassName: "justify-start",
    descriptionClassName: "text-sm text-gray-500 whitespace-nowrap", // Prevent line break
    img: "/grid.svg",
    spareImg: "/b4.svg",
  },

  {
    id: 5,
    title:
      "Currently building AI-Driven Threat Detection and Response for Multi-Cloud Environments using Customizable Security Agents.",
