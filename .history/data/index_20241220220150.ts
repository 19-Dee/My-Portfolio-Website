...
export const gridItems = [
  ...
  },
  {
    ...
    titleClassName: "px-12 pt-12 text-lg font-bold text-white", // Reduced padding to move title up
    descriptionClassName: "px-4 pt-1 pb-2 text-sm text-gray-400", // Adjusted padding to align closer to the title
    img: "",
    spareImg: "",
  },
  {
