...
export const gridItems = [
  {
    ...
    className:
      "lg:col-span-3 md:col-span-3 md:row-span-2 relative overflow-hidden rounded-lg",
    imgClassName:
  ...
  className: "lg:col-span-2 md:col-span-3 md:row-span-2 relative overflow-hidden rounded-lg",
  imgClassName: "absolute top-0 left-0 w-full h-full object-cover transition-transform duration-300 group-hover:scale-105",
  titleClassName: "absolute bottom-4 left-4 text-white text-lg font-semibold z-10",
  descriptionClassName: "absolute top-4 left-4 text-white text-sm z-10",
  img: "/flexible.svg",
  spareImg: "",
}
,
  {
    id: 3,
    title: "My tech stack",
    description: "I constantly try to improve", // Description now properly displayed
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
    titleClassName: "justify-center font-bold text-lg lg:text-2xl",
    descriptionClassName:
      "text-sm text-gray-400 mt-4 overflow-visible whitespace-normal",
    img: "",
    spareImg: "",
  },
  {
