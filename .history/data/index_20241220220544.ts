...
export const gridItems = [
  ...
  },
  {
    ...
    titleClassName: "px-4 pt-6 text-lg font-bold text-white", // Reduced padding to move title up
    descriptionClassName: "px-4 pt-200 pb-2 text-sm text-gray-400", // Adjusted padding to align closer to the title
    img: "",
    spareImg: "",
  },
  {
