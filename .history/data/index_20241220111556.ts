...
export const gridItems = [
  {
    ...
    description: "",
    className:
      "lg:col-span-3 md:col-span-6 md:row-span-4 lg:min-h-[60vh] group relative overflow-hidden border-none shadow-none bg-[#05071d] border border-red-500", // Add `group` and `relative`
    imgClassName:
