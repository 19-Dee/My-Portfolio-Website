...
export const workExperience = [
...

  {
    ...
    desc: {
      text: "Developed an AI-driven solution for real-time threat detection and automated response within AWS environments. The project focuses on creating customizable security agents leveraging machine learning techniques such as anomaly detection and behavioral analysis to identify and mitigate cyber threats in real time.",
      bullets: [
        "Cloud Integration:",
        "- Designed the solution for seamless integration within AWS using services such as SageMaker, Lambda, and CloudWatch.",
        "- Leveraged AWS tools like GuardDuty, Macie, and CloudTrail to gather and process vast amounts of security data.",
        "AI and Machine Learning:",
        "- Built models for anomaly detection and behavioral analysis to enhance threat detection accuracy and adaptability.",
        "- Created a scalable architecture to accommodate multi-cloud environments in the future.",
        "Operational Efficiency:",
        "- Explored ways to automate compliance with security standards and regulatory models.",
        "- Demonstrated how this solution could extend beyond security into cost optimization (FinOps) by minimizing downtime and resource abuse.",
      ],
    },
    className: "md:col-span-2",
    thumbnail: "/exp3.svg",
