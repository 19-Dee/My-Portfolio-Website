...
export const workExperience = [
  ...
  },
  {
    ...
    desc: "Role: Managed day-to-day operations of a family-owned business while balancing university studies. Key Skills: Customer Service: Provided excellent service to customers, enhancing satisfaction and building loyalty. Time Management: Successfully balanced academic responsibilities and business operations. Team Leadership: Oversaw staff schedules, delegated tasks, and resolved issues in a fast-paced environment. Finance Management: Handled cash flow, reconciled daily sales, and ensured accurate accounting records. Problem Solving: Adapted to unexpected challenges, such as stock shortages and customer disputes.",
