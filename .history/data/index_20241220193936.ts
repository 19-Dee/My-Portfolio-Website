...
export const workExperience = [
  ...
  {
    id: 4,
    title: "Cloud Support Engineer – Academic Assistance",
    desc: {
      text: "Assisted fellow students and peers in designing and implementing cloud architectures, troubleshooting cloud environments, and providing guidance on best practices for cloud engineering tasks.",
      bullets: [
        "Student Collaboration:",
        "- Supported peers in understanding and designing secure and scalable cloud architectures on AWS.",
        "- Provided one-on-one and group sessions to help troubleshoot issues in cloud environments, including resource allocation, security configurations, and cost optimization.",
        "- Conducted informal workshops to explain core AWS services, including EC2, S3, IAM, and VPC.",
        "Architecture Design:",
        "- Guided students in building modular, reusable architectures for their projects using AWS services.",
        "- Helped integrate Infrastructure as Code (IaC) principles using Terraform for automating deployments.",
        "- Collaborated on designing CI/CD pipelines using Jenkins and GitHub Actions for automated software delivery.",
        "Problem Solving:",
        "- Resolved common cloud-related challenges, such as misconfigured permissions, network issues, and deployment failures.",
        "- Simplified complex cloud workflows, enabling peers to adopt efficient cloud engineering practices.",
        "Mentorship:",
        "- Acted as a mentor to junior students exploring cloud computing, providing insights into the industry and sharing tips for learning AWS and DevOps tools.",
        "- Shared resources and created detailed walkthroughs for deploying secure and scalable cloud solutions.",
      ],
    },
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
