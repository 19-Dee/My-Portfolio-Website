...
const SocialMedia = () => {
  // Social Media data directly in the file
  const socialMedia = [
    {
      id: 1,
      img: "git.svg", // Make sure this is in the public folder
      link: "https://github.com/19-Dee",
    },
    {
      id: 2,
      img: "twit.svg", // Make sure this is in the public folder
      link: "https://twitter.com/yourhandle", // Replace with your Twitter handle
    },
    {
      id: 3,
      img: "link.svg", // Make sure this is in the public folder
