...
export const workExperience = [
...

  {
    ...
    desc: {
      text: "Developed an AI-driven solution for real-time threat detection and automated response within AWS environments. The project focuses on creating customisable security agents leveraging machine learning techniques such as anomaly detection and behavioral analysis to identify and mitigate cyber threats in real time.",
      bullets: [
