...
export const gridItems = [
  ...
  },
  {
    ...
    className:
      "lg:col-span-2 md:col-span-3 md:row-span-2 relative overflow-hidden rounded-lg",
    imgClassName:
      "absolute top-0 left-0 w-full h-full object-cover transition-transform duration-300 group-hover:scale-105",
    titleClassName:
      "absolute bottom-4 left-4 text-white text-lg font-semibold z-10",
  ...
  },
  {
    ...
    className:
      "lg:col-span-2 md:col-span-3 md:row-span-2 relative overflow-hidden rounded-lg flex flex-col justify-between",
    imgClassName: "",
    titleClassName: "px-4 pt-4 text-lg font-bold text-white",
    descriptionClassName: "px-4 pb-4 text-sm text-gray-400",
    img: "",
    spareImg: "",
  },
  {
