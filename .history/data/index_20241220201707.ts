...
export const gridItems = [
  {
    ...
    description: "",
    className:
      "lg:col-span-3 md:col-span-6 md:row-span-4 lg:min-h-[60vh] group relative overflow-hidden border-none shadow-none",
    imgClassName:
      "absolute top-0 left-0 w-full transition-transform duration-300 transform group-hover:scale-105",
    titleClassName: "relative z-10 justify-end text-white",
    img: "/certs11.svg",
    spareImg: "",
  },
  {
  ...
  className: "lg:col-span-2 md:col-span-3 md:row-span-2 lg:min-h-[30vh] group relative overflow-hidden border-none shadow-none",
  imgClassName: "",
