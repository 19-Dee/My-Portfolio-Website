...
export const testimonials = [
  {
    heading1: "Short-Term Goals",
    heading: "Secure an Internship",
    quote:
      "Kickstart my career by gaining hands-on experience through an internship in any cloud or data based role, tackling real-world challenges.",
    name: "Dishen Patel",
    title: "Aspiring Cloud Engineer",
  },
  {
    heading1: "Mid-Term Goals",
    heading: "Build a Portfolio of Impactful Projects",
    quote:
      "Develop and showcase innovative projects that highlight my ability to solve complex cloud security problems effectively.",
    name: "Dishen Patel",
    title: "Aspiring Cloud Engineer",
  },
  {
    heading1: "Long-Term Goals",
    heading: "Become a Recognised Cloud Security Leader",
    quote:
      "Establish myself as an expert in cloud security, shaping the future of multi-cloud environments and mentoring upcoming talent.",
    name: "Dishen Patel",
    title: "Aspiring Cloud Engineer",
  },
];
